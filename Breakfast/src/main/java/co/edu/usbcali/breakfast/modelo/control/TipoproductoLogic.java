...
//            }
    ...
    public void deleteTipoproducto(Tipoproducto entity)
        ...
        try {
            productos = productoDAO.findByProperty("tipoproducto.codigoTipoproducto",
    ...
    public List<TipoproductoDTO> getDataTipoproducto()
        ...
        try {
            ...
            for (Tipoproducto tipoproductoTmp : tipoproducto) {
                ...
                tipoproductoDTO2.setCodigoTipoproducto(tipoproductoTmp.getCodigoTipoproducto());
                tipoproductoDTO2.setDescripcion((tipoproductoTmp.getDescripcion() != null)
                    ? tipoproductoTmp.getDescripcion() : null);
    ...
    public Tipoproducto getTipoproducto(Long codigoTipoproducto)
        ...
        try {
            entity = tipoproductoDAO.findById(codigoTipoproducto);
        } catch (Exception e) {
    ...
    public List<Tipoproducto> findPageTipoproducto(String sortColumnName,
        ...
        try {
            entity = tipoproductoDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
